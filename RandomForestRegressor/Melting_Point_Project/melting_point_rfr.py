# ================================
# PolyML: mpC prediction script (single cell)
# ================================
...
# --------------------------------
# 3) Baseline RandomForest sanity check
# --------------------------------
...
# --------------------------------
# 4) Gradient boosting model (XGBoost or HistGradientBoosting)
# --------------------------------
use_xgb = False
try:
...
# --------------------------------
# 5) Validation comparison & final training
# --------------------------------
...
# Save core metrics summary into results/ (no change to training logic)
...
with open(metrics_path, "w", encoding="utf-8") as f:
    ...
    f.write(f"RandomForest CV MAE (mean): {rf_cv_maes.mean():.6f} ± {rf_cv_maes.std():.6f}\n")
...
# --------------------------------
# 6) Predict test and save submission
# --------------------------------
...
# Original behavior: submission.csv in current directory
submission.to_csv("submission.csv", index=False)
print("Saved submission.csv in project root.")

# Additional copy into results/ for GitHub-friendly outputs
submission_results_path = os.path.join(RESULTS_DIR, "submission.csv")
submission.to_csv(submission_results_path, index=False)
print(f"Saved submission.csv copy to {submission_results_path}")
